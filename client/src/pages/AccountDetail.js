...
import { IconBuilding, IconUsers, IconTarget, IconClipboard, IconPlus } from '../components/Icons';
    ...
    <div>
      ...
      <div className="stats-grid">
        <div className="stat-card">
          ...
          <div className="stat-info">
            <h4 style={{ fontSize: 18 }}>{account.industry || 'N/A'}</h4>
            <p>Industry</p>
          </div>
        </div>
        <div className="stat-card">
          ...
          <div className="stat-info">
            <h4 style={{ fontSize: 18 }}>{account.company_size || 'N/A'}</h4>
            <p>Company Size</p>
          </div>
        </div>
        <div className="stat-card">
          <div className="stat-icon orange"><IconTarget /></div>
          <div className="stat-info">
        ...
        <div className="stat-card">
          <div className="stat-icon purple"><IconClipboard /></div>
          <div className="stat-info">
      ...
      <div className="card">
        <div className="card-header">
          ...
          <Link to="/scope" className="btn btn-primary btn-sm"><IconPlus size={13} /> New Assessment</Link>
        </div>
